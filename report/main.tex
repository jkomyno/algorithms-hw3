...
\newminted{c++}{
  ...
  \newcommand\complexityKargerTime[0]{TODO}
...
\newtheorem{defn}[thm]{Definizione}
  ...
  \begin{document}
    ...
    \newpage
    \input{chapters/5-problem-definition}
    \input{chapters/6-implementation-choices}

    \newpage
    \input{chapters/7-karger-algorithm}
    ...
    \newpage
    \input{chapters/9-performance-analysis}
    ...
    \newpage
    \appendix
    \input{chapters/A-tables-and-benchmarks}
  \end{document}
