...
\noindent È possibile notare che per la curva di \emph{discovery time} i risultati hanno molta varianza, ma in linea generale essa segue in modo
...
TODO: rinominare KargerTimeout in KargerMinCutTimeout
TODO: mostrare la tabella di KargerMinCutTimeout, con colonne \textbf{istanza}, \textbf{nodi}, \textbf{soluzione attesa}, \textbf{min-cut}.
Le righe devono essere ordinate per istanza e numero crescente di nodi. \\
